...
- Submenus: Benford, Data (with Probability distributions), **Custom lists**, **Ranges**, **Tables**, **Files**, Sampling, **Hyperlinks**, **Power Query**, **Matrices** (Create / Operations / Properties / Validation / Decompositions including **SVD**), **Analysis** (Menu18: SVD, AX=B, confusion, covariance/correlation, vectors, residuals), **Plots Charts** (Menu11: histograms, regression, capability, parametric plots including logistic, QQ, Gini, ACF, Diebold-Mariano, XmR, chart sheet), Worksheet templates.
