...
- Submenus: Benford, Data (with Probability distributions), **Custom lists**, **Tables**, **Files**, Sampling, **Hyperlinks**, **Power Query**, **Matrices** (Create / Operations / Properties / Validation / Decompositions), Worksheet templates.
