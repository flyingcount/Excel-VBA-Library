...
- Submenus: Benford, Data (with Probability distributions), Sampling, **Hyperlinks**, **Power Query**, **Matrices** (Create / Operations / Properties / Validation / Decompositions), Worksheet templates.
