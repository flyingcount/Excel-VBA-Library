...
- Submenus: Benford, Data (with Probability distributions and **Data Preprocessing**), **Custom lists**, **Ranges**, **Duplicates**, **Protection**, **Reconciliations**, **Tables**, **Files**, Sampling, **Hyperlinks**, **Power Query**, **Matrices** (Create / Operations / Properties / Validation / Decompositions including **SVD**), **Analysis** (Menu18: SVD, AX=B, confusion, covariance/correlation, vectors, residuals; Menu5: Bland-Altman, Deming, Box-Cox, logit template), **Plots Charts** (Menu11: histograms, regression, capability, parametric plots including logistic, QQ, Gini, ACF, Diebold-Mariano, XmR, chart sheet), **Time series**, Worksheet templates.
